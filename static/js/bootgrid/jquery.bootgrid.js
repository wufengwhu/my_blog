...
;(function ($, window, undefined) {
    ...
    function addData() {
        BootstrapDialog.show({
            ...
            //            dialogRef.getModalBody().html('正在提交,请稍等...');
            //            setTimeout(function () {
            //                dialogRef.close();
            //            }, 2000);
            //            bi_data_form.submit();
    ...
    function renderActions() {
        if (this.options.navigation !== 0) {
            ...
            if (actionItems.length > 0) {
                ...
                // Add Button
                var addIcon = tpl.icon.resolve(getParams.call(this, {iconCss: css.iconAdd})),
                    add = $(tpl.actionButton.resolve(getParams.call(this,
